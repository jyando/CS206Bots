...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        pyrosim.Send_Cube(name="Torso", pos=[0, 0, 2], size=[c.length, c.width, c.height])
        ...
        pyrosim.Send_Cube(name="LowerFrontLeg", pos=[0, 0, -1], size=[0.2, 0.2, 2])
        pyrosim.Send_Joint(name="BackLeg_LowerBackLeg", parent="BackLeg", child="LowerBackLeg", type="revolute",
                           position=[0, -1, 0], jointAxis="1 0 0")
        pyrosim.Send_Cube(name="LowerBackLeg", pos=[0, 0, -1], size=[0.2, 0.2, 2])
        ...
        pyrosim.Send_Cube(name="LowerRightLeg", pos=[0, 0, -1], size=[0.2, 0.2, 2])
        pyrosim.Send_Joint(name="LeftLeg_LowerLeftLeg", parent="LeftLeg", child="LowerLeftLeg", type="revolute",
                           position=[-1,0, 0], jointAxis="0 1 0")
        pyrosim.Send_Cube(name="LowerLeftLeg", pos=[0, 0, -1], size=[0.2, 0.2, 2])
